...
l_r = input("You're at a crossroad. Where do you want to go? Type 'left' or 'right'\n").lower()
if l_r == "left":
  ...
  if wait_swim == "wait":
    ...
    if doors == "yellow":
      ...
      print("You burst into flames as you open the door.  Game Over")
    else:
      print("You fell off the Earth. Game Over.")
  else:
